...
const FormForEdit: React.FC = () => {
    ...
    const fetchCaseData = async (refNr: string) => {
        ...
        try {
            ...
            if (!response.ok) {
                throw new Error(`Feil ved henting av sakdata: ${response.status} ${response.statusText}`);
            }
    ...
    const handleUpdateCase = async (e: React.FormEvent) => {
        ...
        setError('');
        try {
            const response = await fetch(`http://localhost:5150/api/Case/${caseData.referenceNr}`, {
                method: 'PUT',
                headers: {
            ...
            if (!response.ok) {
                throw new Error(`Feil ved oppdatering av sak: ${response.status} ${response.statusText}`);
            }
    ...
    return (
        <Container>
            ...
            {caseData ? (
                <Form onSubmit={handleUpdateCase}>
                    ...
                    <Form.Field>
                        ...
                        <Input
                            ...
                            onChange={(e) => setCaseData({ ...caseData, orgNr: e.target.value })}
                        />
                    </Form.Field>
                    <Form.Field>
                        ...
                        <Input
                            ...
                            onChange={(e) => setCaseData({ ...caseData, workerName: e.target.value })}
                        />
                    </Form.Field>
                    <Form.Field>
                        ...
                        <Input
                            ...
                            onChange={(e) => setCaseData({ ...caseData, workerEmail: e.target.value })}
                        />
                    </Form.Field>
                    <Form.Field>
                        ...
                        <Input
                            type="radio"
                            checked={!caseData.hasObjections}
                            onChange={() => setCaseData({ ...caseData, hasObjections: false })}
                        /> Nei
                    </Form.Field>
                    <Form.Field>
                        ...
                        <Input
                            ...
                            onChange={() => setCaseData({ ...caseData, departureDateMismatch: true })}
                        /> Ja
                        <Input
                            type="radio"
                            checked={!caseData.departureDateMismatch}
                            onChange={() => setCaseData({ ...caseData, departureDateMismatch: false })}
                        /> Nei
                    </Form.Field>
                    <Form.Field>
                        ...
                        <Input
                            ...
                            min={today}
                            onChange={(e) => setCaseData({ ...caseData, proposedDate: e.target.value + 'T00:00:00Z' })}
                        />
                    </Form.Field>
                    <Form.Field>
                        ...
                        <Input
                            ...
                            onChange={() => setCaseData({ ...caseData, debtAsCauseOfObjection: true })}
                        /> Ja
                        <Input
                            type="radio"
                            checked={!caseData.debtAsCauseOfObjection}
                            onChange={() => setCaseData({ ...caseData, debtAsCauseOfObjection: false })}
                        /> Nei
                    </Form.Field>
                    <Form.Field>
                        ...
                        <Input
                            ...
                            onChange={(e) => setCaseData({ ...caseData, debtValue: parseFloat(e.target.value) })}
                        />
                    </Form.Field>
             ...
             <Button color="blue" onClick={() => navigate("/form/1")} style={{ marginTop: '20px' }}>
                Nytt skjema
            </Button>
        </Container>
    );
